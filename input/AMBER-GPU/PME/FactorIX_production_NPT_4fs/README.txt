This is Factor IX in a TIP3P Water box - 90,906 atoms.
...
This is a more realistic version of the Factor IX benchmark run with what would
be typical NPT production parameters.  It uses shake with a 4fs timestep.  It
has a 9 Angstrom cutoff and writes output and trajectory files every 2500 steps
