...
for i in "${BENCHMARKS[@]}"; do
    ...
    # Main GROMACS run
    /home/atuin/unrz/unrz007h/new_spack/opt/spack/linux-ubuntu22.04-neoverse_v2/gcc-12.3.0/gromacs-2024.1-gnqvkzl5p7vjlwhttzsrr63sqlu264yt/bin/gmx mdrun -nsteps $NSTEPS $OPTIONS -s ${INPUTFILE_LOCATION}$i.tpr -deffnm ${i}_${FREQ_TAG}_${HOSTNAME}_perflog  -g ${i}_${FREQ_TAG}_${HOSTNAME}_perflog.log -gpu_id $CUDA_VISIBLE_DEVICES${i}_${FREQ_TAG}_${HOSTNAME}-${SLURM_JOB_ID}.out 2>&1
