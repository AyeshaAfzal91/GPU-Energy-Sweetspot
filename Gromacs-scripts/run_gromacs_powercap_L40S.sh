...
# === Load modules ===
module load cuda nvhpc gromacs/2024.3-gcc-mkl-cuda11.7 # gromacs/2024.3-gcc-mkl-cuda11.7 (testcluster) gromacs/2023.3-gcc11.4.0-openmpi-openblas-fftw-cuda-h5ojrrx (gracehop1) # module load gromacs/2024.2-gcc-mkl-cuda11.7 # for testcluster gromacs/2024.4-gcc11.2.0-mkl-cuda (alex)
module avail 
