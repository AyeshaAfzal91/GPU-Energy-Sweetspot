...
BENCHMARKS=(system7_KP) #2md_start0 FL_md1_berendsen PI_large_test eag1 rnanvt stmv_pme_nvt)
...
for i in "${BENCHMARKS[@]}"; do
    ...
    # Main GROMACS run
    gmx mdrun -nsteps $NSTEPS $OPTIONS -s ${INPUTFILE_LOCATION}$i.tpr -deffnm ${i}_${FREQ_TAG}_${HOSTNAME}_perflog  -g ${i}_${FREQ_TAG}_${HOSTNAME}_perflog.log -gpu_id $CUDA_VISIBLE_DEVICES > ${i}_${FREQ_TAG}_${HOSTNAME}_perflog.stdout
