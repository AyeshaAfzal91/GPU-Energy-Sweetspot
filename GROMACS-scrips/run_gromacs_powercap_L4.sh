...
#SBATCH --output=icx32-L4-%j.out
#SBATCH --export=ALL

# === Load modules ===
export MODULESHOME=/apps/modules/5.1.1
module load cuda nvhpc gromacs/2024.3-gcc-mkl-cuda11.7 #gromacs/2024.4 # gromacs/2024.3-gcc-mkl-cuda11.7 (testcluster) gromacs/2023.3-gcc11.4.0-openmpi-openblas-fftw-cuda-h5ojrrx (gracehop1) # module load gromacs/2024.2-gcc-mkl-cuda11.7 # for testcluster gromacs/2024.4-gcc11.2.0-mkl-cuda (alex)
module avail 
